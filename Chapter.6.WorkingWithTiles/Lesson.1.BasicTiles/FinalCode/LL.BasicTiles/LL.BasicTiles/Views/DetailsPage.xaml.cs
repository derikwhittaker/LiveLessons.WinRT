using LL.BasicTiles.Common;
using LL.BasicTiles.Data;
using System;
...
namespace LL.BasicTiles.Views
{
    /// <summary>
    /// A page that displays a group title, a list of items within the group, and details for the
    /// currently selected item.
    /// </summary>
    public sealed partial class DetailsPage : LL.BasicTiles.Common.LayoutAwarePage
    {
        public DetailsPage()
        {
        ...
        {
            if (itemsViewSource.View != null && DataContext is DetailsViewModel)
            {
                // LL - Custom COde here
                var selectedItem = ((DetailsViewModel) DataContext).SelectedItem;
