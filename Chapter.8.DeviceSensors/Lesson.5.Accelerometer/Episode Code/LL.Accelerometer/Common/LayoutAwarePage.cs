...
namespace LL.Accelerometer.Common
{
    /// <summary>
    ...
    public class LayoutAwarePage : Page
    {
        ...
        /// <summary>
        /// Translates <see cref="ApplicationLightSensor"/> values into strings for visual state
        /// management within the page.  The default implementation uses the names of enum values.
        /// Subclasses may override this method to control the mapping scheme used.
        /// </summary>
        /// <param name="LightSensor">View state for which a visual state is desired.</param>
